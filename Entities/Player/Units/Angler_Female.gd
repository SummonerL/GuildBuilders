...
const CANT_TAP_WITHOUT_TAPPER_TEXT = 'I need a tree tapper if I want to do that...'
...
func unit_init():	
	...
	item_mounting_representation = global_items_list.item_ripley_mount_representation
