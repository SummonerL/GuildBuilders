...
onready var ITEMS_AT_SPOT = {
	...
	'MISC_SPOT_2': [global_items_list.item_mushroom],
}
...
onready var associated_actions = {
	...
	'MISC_SPOT_2': [global_action_list.COMPLETE_ACTION_LIST.TAKE_MUSHROOM],
	...
	'CAVE_CONNECTOR_1': [global_action_list.COMPLETE_ACTION_LIST.SLEEP_IN_CAVE, global_action_list.COMPLETE_ACTION_LIST.TUNNEL],
	'CAVE_CONNECTOR_2': [global_action_list.COMPLETE_ACTION_LIST.SLEEP_IN_CAVE, global_action_list.COMPLETE_ACTION_LIST.TUNNEL],
	'CAVE_CONNECTOR_3': [global_action_list.COMPLETE_ACTION_LIST.SLEEP_IN_CAVE, global_action_list.COMPLETE_ACTION_LIST.TUNNEL],
	'CAVE_CONNECTOR_4': [global_action_list.COMPLETE_ACTION_LIST.SLEEP_IN_CAVE, global_action_list.COMPLETE_ACTION_LIST.TUNNEL],
	'GENERIC_CONNECTOR_5': [global_action_list.COMPLETE_ACTION_LIST.FOLLOW_NPC],
	'GENERIC_CONNECTOR_6': [],
	'CAVE_CONNECTOR_7': [global_action_list.COMPLETE_ACTION_LIST.SLEEP_IN_CAVE, global_action_list.COMPLETE_ACTION_LIST.TUNNEL],
	'CAVE_CONNECTOR_8': [global_action_list.COMPLETE_ACTION_LIST.SLEEP_IN_CAVE, global_action_list.COMPLETE_ACTION_LIST.TUNNEL]
}
